          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="<?php echo site_url('/SPK_bergaransi');?>">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="<?php echo site_url('/SPK');?>">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
